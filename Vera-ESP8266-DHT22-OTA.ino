/**
 * ESP8266 12F and DHT22 Temperature and Humidity Sersor with Vera integration. 
 * 
 * Partly based on 
...
int ReadSensor() {
  ...
  glb_temp = dht.readTemperature();
  glb_hum = dht.readHumidity();

  // Check if any reads failed and exit early (to try again).
  if (isnan(glb_hum) || isnan(glb_temp)) {
